...
const casinos: Casino[] = [
  {
    ...
    rating: 4.0,
    safetyIndex: 'Medium',
    bonus: 'Welcome Bonus Up To 400% + Daily Rebate 8%',
    features: ['Live Dealers', 'Local & Crypto Payments', 'VIP Program', 'Mobile App', '24/7 Support'],
    description: 'Many Bonus Many Chance, Giving you more options to chocing Type Of Bonus Section Games.',
    badges: ['Big Bonus', 'Not Licensed by CGSG'],
    isNew: false,
    links: {
  ...
  },
  {
    ...
    features: ['Mini Games', '24/7 Support', 'Local Payments', 'VIP Program'],
    description: 'Huge Your Chance with more Experience Play Large Welcome Bonus',
    badges: ['Big Bonuses', 'Not Licensed by CGSG'],
    isNew: false,
    links: {
