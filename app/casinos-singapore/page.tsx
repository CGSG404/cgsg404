          ...
          <div className="mb-8">
            <div className="text-center mb-6">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Discover verified online casinos with comprehensive reviews, safety ratings,
                and exclusive bonuses. All casinos are thoroughly tested for fairness and security.
              </p>
            </div>
